...
def _build_banking_tasks(agents: dict, analysis_request: str, langgraph_plan: dict = None) -> list:
    ...
    task_analyst = Task(
        description=(
            ...
            "HOW TO CALL 'Generate Data Visualization':\n"
            "IMPORTANT: Call the tool ONCE per chart. NEVER pass a list or array.\n"
            "Each call must be a single JSON dictionary with these exact keys:\n"
            "  table_name, chart_type, x_column, y_column, title, hue_column\n\n"
            "Correct examples (one dict per call — do this):\n"
            '  {"table_name": "churn", "chart_type": "pie", "x_column": "Churn", "y_column": "", "title": "Churn Distribution", "hue_column": ""}\n'
            '  {"table_name": "churn", "chart_type": "histogram", "x_column": "tenure", "y_column": "", "title": "Tenure Distribution", "hue_column": ""}\n'
            '  {"table_name": "churn", "chart_type": "histplot", "x_column": "MonthlyCharges", "y_column": "", "title": "Monthly Charges by Churn", "hue_column": "Churn"}\n'
            '  {"table_name": "churn", "chart_type": "scatter", "x_column": "tenure", "y_column": "MonthlyCharges", "title": "Tenure vs Charges", "hue_column": "Churn"}\n'
            '  {"table_name": "churn", "chart_type": "bar", "x_column": "Contract", "y_column": "MonthlyCharges", "title": "Contract vs Charges", "hue_column": ""}\n'
            '  {"table_name": "churn_encoded", "chart_type": "heatmap", "x_column": "Churn", "y_column": "", "title": "Feature Correlation Heatmap", "hue_column": ""}\n\n'
            "WRONG — never do this (do NOT pass a list):\n"
            '  [{"table_name": "churn", ...}, {"table_name": "churn", ...}]\n\n'
            "Required deliverables:\n"
            "1. Individual charts (at least 5 meaningful charts — DO NOT generate a dashboard)\n"
            "2. A text report: Generate Business Insight Report with ALL team analysis results\n"
