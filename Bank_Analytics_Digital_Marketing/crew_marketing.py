...
def _build_marketing_agents() -> dict:
    ...
    content_maker = Agent(
        ...
        backstory=(
            ...
            "major financial brand campaigns. You leverage Google Veo 3 for video generation "
            "combined with expert copywriting."
        ),
        tools=[
            generate_video_content,
            write_ad_copy,
...
def _build_marketing_tasks(
    ...
    task_content = Task(
        description=(
            ...
            "1. Generate at least 1 AI video using Veo 3 (brand story or retention campaign video).\n"
