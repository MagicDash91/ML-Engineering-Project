    ...
    try:
        ...
        for raw_line in report_content.split("\n"):
            ...
            if not line:
                ...
                # Replace all **bold** spans on the line
                formatted = _bold_re.sub(r"<b>\1</b>", line)
        ...
        if chart_paths:
            try:
                ...
                # LLM sometimes produces Python-style lists with single quotes
                try:
...
def generate_ppt_report(
    ...
    try:
        ...
        # Normalise ## and ### headings so the split works regardless of LLM heading depth
        import re as _re
